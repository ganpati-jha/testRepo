...
public interface IPublicTestWindow {

  /**
   * Provides access to the generic API of this controller.
   */
  IWDWindowController wdGetAPI();
  ...
  {
    private static final long serialVersionUID = 0x7b5b093a5c90dadeL;
    
    private InternalTestWindow gen_delegate;

    IContextNode(InternalTestWindow delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateTestWindow.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateTestWindow.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateTestWindow.IContextElement createContextElement() {
      return (IPrivateTestWindow.IContextElement)createElement();
    }
     ...
     * @return an element for this node
     */
    public IPrivateTestWindow.IContextElement createAndAddContextElement() {
      return (IPrivateTestWindow.IContextElement)createAndAddElement();
    }
     ...
     */
    public void bind(IPrivateTestWindow.IContextElement element) {
     ...
     */
    public IPrivateTestWindow.IContextElement currentContextElement() {
      return (IPrivateTestWindow.IContextElement) getCurrentElement();
    }
  ...
  {
    private static final long serialVersionUID = 0x25d358c4231acba4L;
    
    private InternalTestWindow gen_delegate;

    IContextElement(InternalTestWindow delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
