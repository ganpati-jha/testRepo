...
// AT LEAST ONE IMPORT STATEMENT (E.G. THAT FOR IPrivateTestWindow).
// OTHERWISE, USING THE ECLIPSE FUNCTION "Organize Imports" FOLLOWED BY
// A WEB DYNPRO CODE GENERATION (E.G. PROJECT BUILD) WILL RESULT IN THE LOSS
// OF IMPORT STATEMENTS.
//
//@@begin imports
import com.sap.demo.test_wd1.wd.comp.testcomp.wdp.IPrivateTestWindow;
...
public class TestWindow implements java.io.Serializable 
{
  private static final long serialVersionUID = 0xd0a2942c3429450bL;
   ...
   * component usages.
   *
   * @see com.sap.demo.test_wd1.wd.comp.testcomp.wdp.IPrivateTestWindow for more details
   */
  @SuppressWarnings("unused")
  private final IPrivateTestWindow wdThis;
   ...
   *
   * @see com.sap.demo.test_wd1.wd.comp.testcomp.wdp.IPrivateTestWindow.IContextNode for more details.
   */
  @SuppressWarnings("unused")
  private final IPrivateTestWindow.IContextNode wdContext;
   ...
   */
  public TestWindow(IPrivateTestWindow wdThis)
  {
    this.wdThis = wdThis;
