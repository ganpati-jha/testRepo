...
// AT LEAST ONE IMPORT STATEMENT (E.G. THAT FOR IPrivateTestComp).
// OTHERWISE, USING THE ECLIPSE FUNCTION "Organize Imports" FOLLOWED BY
// A WEB DYNPRO CODE GENERATION (E.G. PROJECT BUILD) WILL RESULT IN THE LOSS
// OF IMPORT STATEMENTS.
//
//@@begin imports
import com.sap.demo.test_wd1.wd.comp.testcomp.wdp.IPrivateTestComp;
...
public class TestComp implements java.io.Serializable 
{
  private static final long serialVersionUID = 0xc94e464bd2627293L;
   ...
   * component usages.
   *
   * @see com.sap.demo.test_wd1.wd.comp.testcomp.wdp.IPrivateTestComp for more details
   */
  @SuppressWarnings("unused")
  private final IPrivateTestComp wdThis;
   ...
   *
   * @see com.sap.demo.test_wd1.wd.comp.testcomp.wdp.IPrivateTestComp.IContextNode for more details.
   */
  @SuppressWarnings("unused")
  private final IPrivateTestComp.IContextNode wdContext;
   ...
   */
  public TestComp(IPrivateTestComp wdThis)
  {
    this.wdThis = wdThis;
