...
public class InternalTestWindow
  extends com.sap.tc.webdynpro.progmodel.gci.impl.GCIWindowController
  implements IPrivateTestWindow, com.sap.tc.webdynpro.progmodel.gci.IGCIViewDelegate
{
  private static final long serialVersionUID = 0x688780542a01e116L;
   ...
   */
  private final com.sap.demo.test_wd1.wd.comp.testcomp.TestWindow delegate;
   ...
   */
  public InternalTestWindow(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    super(alterEgo);
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.sap.demo.test_wd1.wd.comp.testcomp.TestWindow((IPrivateTestWindow) this);
  }
