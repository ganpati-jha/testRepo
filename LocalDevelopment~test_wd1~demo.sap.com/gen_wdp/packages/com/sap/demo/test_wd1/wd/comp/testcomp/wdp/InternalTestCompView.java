...
public class InternalTestCompView
  extends com.sap.tc.webdynpro.progmodel.gci.impl.GCIViewController
  implements IPrivateTestCompView, com.sap.tc.webdynpro.progmodel.gci.IGCIViewDelegate
{
  private static final long serialVersionUID = 0x835f59b81d9afac1L;
   ...
   */
  private final com.sap.demo.test_wd1.wd.comp.testcomp.TestCompView delegate;
   ...
   */
  public InternalTestCompView(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    super(alterEgo);
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.sap.demo.test_wd1.wd.comp.testcomp.TestCompView((IPrivateTestCompView) this);
  }
