...
public class InternalTestComp
  extends com.sap.tc.webdynpro.progmodel.gci.impl.GCIComponentController
  implements IPrivateTestComp, com.sap.tc.webdynpro.progmodel.gci.IGCIComponentDelegate
{
  private static final long serialVersionUID = 0x9a501c73ce380a59L;
   ...
   */
  private final com.sap.demo.test_wd1.wd.comp.testcomp.TestComp delegate;
   ...
   */
  public InternalTestComp(com.sap.tc.webdynpro.progmodel.gci.IGCIComponent alterEgo) {
    super(alterEgo);
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.sap.demo.test_wd1.wd.comp.testcomp.TestComp((IPrivateTestComp) this);
  }
